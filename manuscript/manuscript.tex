...
%mention palmer drought index?
% find and replace "water temperature" with T_water, same for air
...
% Dotted arrow indicates lack of association with either axis shown
\\[\baselineskip]
